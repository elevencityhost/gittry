 ...
 * This class is used to get  the response of the audits 
 **/
...
@JsonPropertyOrder({
    "batch_counter",    "comment",    "external_id",    "interface_id",    "job_id",    "phase_id",    "prop_name",    "prop_value",    "status_id",    "system_id"
})
public class AuditGetResponse {
