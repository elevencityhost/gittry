...
public class ExtractORCDCHGMsgTypeInterfaceProperties implements Callable {
	...
	public Object onCall(MuleEventContext eventContext) throws Exception {
		...
		List orderChangeMsgList = (List) D97A.get("ORDCHG");
		...
		for (int i = 0; i < orderChangeMsgList.size(); i++) {

			Map response = (Map) orderChangeMsgList.get(i);
