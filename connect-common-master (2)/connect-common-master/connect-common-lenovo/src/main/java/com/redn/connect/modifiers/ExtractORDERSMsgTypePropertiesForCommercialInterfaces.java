...
public class ExtractORDERSMsgTypePropertiesForCommercialInterfaces implements Callable {
	...
	public Object onCall(MuleEventContext eventContext) throws Exception {
		...
		for (int i = 0; i < ordersMessageList.size(); i++) {

			Map response = (Map) ordersMessageList.get(i);
