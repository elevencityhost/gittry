...
public class ExtractORDCHGMsgTypePropertiesForCommercialInterfaces implements Callable {
	...
	public Object onCall(MuleEventContext eventContext) throws Exception {
		...
		for (int i = 0; i < ordchgMessageList.size(); i++) {

			Map response = (Map) ordchgMessageList.get(i);
